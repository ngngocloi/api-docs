...
// Thêm middleware để phục vụ các file tĩnh trong thư mục 'cos'
app.use('/cos', express.static(path.join(__dirname, 'cos')));
app.use('/gai', express.static(path.join(__dirname, 'gai')));
